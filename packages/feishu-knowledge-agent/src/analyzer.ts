...
import type { ExtractedContent, KnowledgeRecord, MessageIntent, MessageIntentName, Recommendation } from "./types.js";
...
Return schema:
{
  "intent": "archive_links | ask_question | list_records | server_status | help",
...
export async function analyzeForArchive(
	...
	config: Config,
): Promise<Omit<KnowledgeRecord, "id" | "createdAt" | "rawText">> {
